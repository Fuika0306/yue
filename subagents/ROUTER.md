...
### 模式 A：空 → 主代理 → 剀 → 主代理 → 衛（标准流程）
1. 主代理召唤空进行深度分析
2. 空完成分析，announce 回主代理
3. 主代理看结果，决定是否召唤剀进行实现
4. 剀完成代码/方案，announce 回主代理
5. 主代理看结果，决定是否召唤衛进行快速检查
6. 衛完成检查，announce 回主代理
7. 主代理汇总结果回复主人

### 模式 B：空 → 主代理 → 衛（快速验证）
1. 主代理召唤空提出想法
2. 空完成分析，announce 回主代理
3. 主代理看结果，召唤衛快速检查是否靠谱
4. 衛反馈结果，主代理决定是否继续

### 模式 C：剀 → 主代理 → 衛（快速反馈）
1. 主代理召唤剀完成代码/方案
2. 剀完成，announce 回主代理
3. 主代理看结果，召唤衛快速检查是否有问题
4. 衛反馈结果，主代理决定是否返工或提交
...
**最后更新：** 2026-02-16 02:48 GMT+8 | 状态：命名统一完成 ✅
